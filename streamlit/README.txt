Чтобы проверить демонстрацию работы парсера и корректной маркировки plan/apply, 
timestamp и уровня логов нужно запустить код через скрипт-команду в "cmd" или "Powershell": 

Для начало надо обратиться в папку где находиться parse.py

1) Для файла "3. apply_tflog.json": \*python parse.py "4. tflog.json" "parsed_tflog.jsonl"*/ (без \* */)

2) Для файла "4. tflog.json": \*python parse.py "3. apply_tflog.json" "parsed_apply.jsonl"*/ (без \* */)

3) Для файла "5. tflog.json": \*python parse.py "5. tflog.json" "parsed_tflog2.0.jsonl"*/ (без \* */)
